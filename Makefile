#############################################################################
# Makefile for building: trustycoin-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat Dec 2 12:33:26 2017
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -D_FILE_OFFSET_BITS=64 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -m64 -pipe -O2 -D_REENTRANT -Wall -W $(DEFINES)
CXXFLAGS      = -m64 -pipe -fstack-protector-all -O2 -D_REENTRANT -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /mnt/e/github/TrustyCoin/src/leveldb/libleveldb.a /mnt/e/github/TrustyCoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/qt/trustycoin.cpp \
		src/qt/trustycoingui.cpp \
		...
		src/noui.cpp \
		src/leveldb.cpp \
		src/txdb.cpp build/moc_trustycoingui.cpp \
		...
		build/moc_trustycoinaddressvalidator.cpp \
		...
		build/moc_trustycoinamountfield.cpp \
		...
		qrc_trustycoin.cpp
OBJECTS       = build/trustycoin.o \
		build/trustycoingui.o \
		...
		build/trustycoinaddressvalidator.o \
		build/alert.o \
		build/version.o \
		build/sync.o \
		build/util.o \
		...
		build/trustycoinstrings.o \
		build/trustycoinamountfield.o \
		build/wallet.o \
		build/keystore.o \
		build/transactionfilterproxy.o \
		build/transactionview.o \
		build/walletmodel.o \
		build/trustycoinrpc.o \
		build/rpcdump.o \
		build/rpcnet.o \
		build/rpcmining.o \
		build/rpcwallet.o \
		...
		build/moc_trustycoinaddressvalidator.o \
		...
		build/moc_trustycoinamountfield.o \
...
dist: 
	@$(CHK_DIR_EXISTS) build/trustycoin-qt0.8.0 || $(MKDIR) build/trustycoin-qt0.8.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/trustycoin-qt0.8.0/ && $(COPY_FILE) --parents src/qt/locale/trustycoin_bg.ts src/qt/locale/trustycoin_ca_ES.ts src/qt/locale/trustycoin_cs.ts src/qt/locale/trustycoin_da.ts src/qt/locale/trustycoin_de.ts src/qt/locale/trustycoin_el_GR.ts src/qt/locale/trustycoin_en.ts src/qt/locale/trustycoin_es.ts src/qt/locale/trustycoin_es_CL.ts src/qt/locale/trustycoin_et.ts src/qt/locale/trustycoin_eu_ES.ts src/qt/locale/trustycoin_fa.ts src/qt/locale/trustycoin_fa_IR.ts src/qt/locale/trustycoin_fi.ts src/qt/locale/trustycoin_fr.ts src/qt/locale/trustycoin_fr_CA.ts src/qt/locale/trustycoin_gu_IN.ts src/qt/locale/trustycoin_he.ts src/qt/locale/trustycoin_hi_IN.ts src/qt/locale/trustycoin_hr.ts src/qt/locale/trustycoin_hu.ts src/qt/locale/trustycoin_it.ts src/qt/locale/trustycoin_ja.ts src/qt/locale/trustycoin_lt.ts src/qt/locale/trustycoin_nb.ts src/qt/locale/trustycoin_nl.ts src/qt/locale/trustycoin_pl.ts src/qt/locale/trustycoin_pt_BR.ts src/qt/locale/trustycoin_pt_PT.ts src/qt/locale/trustycoin_ro_RO.ts src/qt/locale/trustycoin_ru.ts src/qt/locale/trustycoin_sk.ts src/qt/locale/trustycoin_sr.ts src/qt/locale/trustycoin_sv.ts src/qt/locale/trustycoin_th_TH.ts src/qt/locale/trustycoin_tr.ts src/qt/locale/trustycoin_uk.ts src/qt/locale/trustycoin_zh_CN.ts src/qt/locale/trustycoin_zh_TW.ts build/trustycoin-qt0.8.0/ && $(COPY_FILE) --parents src/qt/trustycoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/trustycoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/irc.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/trustycoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/trustycoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/trustycoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h build/trustycoin-qt0.8.0/ && $(COPY_FILE) --parents src/qt/trustycoin.qrc build/trustycoin-qt0.8.0/ && $(COPY_FILE) --parents src/qt/trustycoin.cpp src/qt/trustycoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/trustycoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/irc.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/trustycoinstrings.cpp src/qt/trustycoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/trustycoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/trustycoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp build/trustycoin-qt0.8.0/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/trustycoin-qt0.8.0/ && $(COPY_FILE) --parents src/qt/locale/trustycoin_bg.ts src/qt/locale/trustycoin_ca_ES.ts src/qt/locale/trustycoin_cs.ts src/qt/locale/trustycoin_da.ts src/qt/locale/trustycoin_de.ts src/qt/locale/trustycoin_el_GR.ts src/qt/locale/trustycoin_en.ts src/qt/locale/trustycoin_es.ts src/qt/locale/trustycoin_es_CL.ts src/qt/locale/trustycoin_et.ts src/qt/locale/trustycoin_eu_ES.ts src/qt/locale/trustycoin_fa.ts src/qt/locale/trustycoin_fa_IR.ts src/qt/locale/trustycoin_fi.ts src/qt/locale/trustycoin_fr.ts src/qt/locale/trustycoin_fr_CA.ts src/qt/locale/trustycoin_gu_IN.ts src/qt/locale/trustycoin_he.ts src/qt/locale/trustycoin_hi_IN.ts src/qt/locale/trustycoin_hr.ts src/qt/locale/trustycoin_hu.ts src/qt/locale/trustycoin_it.ts src/qt/locale/trustycoin_ja.ts src/qt/locale/trustycoin_lt.ts src/qt/locale/trustycoin_nb.ts src/qt/locale/trustycoin_nl.ts src/qt/locale/trustycoin_pl.ts src/qt/locale/trustycoin_pt_BR.ts src/qt/locale/trustycoin_pt_PT.ts src/qt/locale/trustycoin_ro_RO.ts src/qt/locale/trustycoin_ru.ts src/qt/locale/trustycoin_sk.ts src/qt/locale/trustycoin_sr.ts src/qt/locale/trustycoin_sv.ts src/qt/locale/trustycoin_th_TH.ts src/qt/locale/trustycoin_tr.ts src/qt/locale/trustycoin_uk.ts src/qt/locale/trustycoin_zh_CN.ts src/qt/locale/trustycoin_zh_TW.ts build/trustycoin-qt0.8.0/ && (cd `dirname build/trustycoin-qt0.8.0` && $(TAR) trustycoin-qt0.8.0.tar trustycoin-qt0.8.0 && $(COMPRESS) trustycoin-qt0.8.0.tar) && $(MOVE) `dirname build/trustycoin-qt0.8.0`/trustycoin-qt0.8.0.tar.gz . && $(DEL_FILE) -r build/trustycoin-qt0.8.0


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /mnt/e/github/TrustyCoin/src/leveldb/libleveldb.a; cd /mnt/e/github/TrustyCoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/mnt/e/github/TrustyCoin/src/leveldb/libleveldb.a: FORCE
	cd /mnt/e/github/TrustyCoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all" libleveldb.a libmemenv.a

/mnt/e/github/TrustyCoin/build/build.h: FORCE
	cd /mnt/e/github/TrustyCoin; /bin/sh share/genbuild.sh /mnt/e/github/TrustyCoin/build/build.h
...
compiler_TSQM_make_all: src/qt/locale/trustycoin_bg.qm src/qt/locale/trustycoin_ca_ES.qm src/qt/locale/trustycoin_cs.qm src/qt/locale/trustycoin_da.qm src/qt/locale/trustycoin_de.qm src/qt/locale/trustycoin_el_GR.qm src/qt/locale/trustycoin_en.qm src/qt/locale/trustycoin_es.qm src/qt/locale/trustycoin_es_CL.qm src/qt/locale/trustycoin_et.qm src/qt/locale/trustycoin_eu_ES.qm src/qt/locale/trustycoin_fa.qm src/qt/locale/trustycoin_fa_IR.qm src/qt/locale/trustycoin_fi.qm src/qt/locale/trustycoin_fr.qm src/qt/locale/trustycoin_fr_CA.qm src/qt/locale/trustycoin_gu_IN.qm src/qt/locale/trustycoin_he.qm src/qt/locale/trustycoin_hi_IN.qm src/qt/locale/trustycoin_hr.qm src/qt/locale/trustycoin_hu.qm src/qt/locale/trustycoin_it.qm src/qt/locale/trustycoin_ja.qm src/qt/locale/trustycoin_lt.qm src/qt/locale/trustycoin_nb.qm src/qt/locale/trustycoin_nl.qm src/qt/locale/trustycoin_pl.qm src/qt/locale/trustycoin_pt_BR.qm src/qt/locale/trustycoin_pt_PT.qm src/qt/locale/trustycoin_ro_RO.qm src/qt/locale/trustycoin_ru.qm src/qt/locale/trustycoin_sk.qm src/qt/locale/trustycoin_sr.qm src/qt/locale/trustycoin_sv.qm src/qt/locale/trustycoin_th_TH.qm src/qt/locale/trustycoin_tr.qm src/qt/locale/trustycoin_uk.qm src/qt/locale/trustycoin_zh_CN.qm src/qt/locale/trustycoin_zh_TW.qm
compiler_TSQM_clean:
	-$(DEL_FILE) src/qt/locale/trustycoin_bg.qm src/qt/locale/trustycoin_ca_ES.qm src/qt/locale/trustycoin_cs.qm src/qt/locale/trustycoin_da.qm src/qt/locale/trustycoin_de.qm src/qt/locale/trustycoin_el_GR.qm src/qt/locale/trustycoin_en.qm src/qt/locale/trustycoin_es.qm src/qt/locale/trustycoin_es_CL.qm src/qt/locale/trustycoin_et.qm src/qt/locale/trustycoin_eu_ES.qm src/qt/locale/trustycoin_fa.qm src/qt/locale/trustycoin_fa_IR.qm src/qt/locale/trustycoin_fi.qm src/qt/locale/trustycoin_fr.qm src/qt/locale/trustycoin_fr_CA.qm src/qt/locale/trustycoin_gu_IN.qm src/qt/locale/trustycoin_he.qm src/qt/locale/trustycoin_hi_IN.qm src/qt/locale/trustycoin_hr.qm src/qt/locale/trustycoin_hu.qm src/qt/locale/trustycoin_it.qm src/qt/locale/trustycoin_ja.qm src/qt/locale/trustycoin_lt.qm src/qt/locale/trustycoin_nb.qm src/qt/locale/trustycoin_nl.qm src/qt/locale/trustycoin_pl.qm src/qt/locale/trustycoin_pt_BR.qm src/qt/locale/trustycoin_pt_PT.qm src/qt/locale/trustycoin_ro_RO.qm src/qt/locale/trustycoin_ru.qm src/qt/locale/trustycoin_sk.qm src/qt/locale/trustycoin_sr.qm src/qt/locale/trustycoin_sv.qm src/qt/locale/trustycoin_th_TH.qm src/qt/locale/trustycoin_tr.qm src/qt/locale/trustycoin_uk.qm src/qt/locale/trustycoin_zh_CN.qm src/qt/locale/trustycoin_zh_TW.qm
src/qt/locale/trustycoin_bg.qm: src/qt/locale/trustycoin_bg.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_bg.ts -qm src/qt/locale/trustycoin_bg.qm

src/qt/locale/trustycoin_ca_ES.qm: src/qt/locale/trustycoin_ca_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_ca_ES.ts -qm src/qt/locale/trustycoin_ca_ES.qm

src/qt/locale/trustycoin_cs.qm: src/qt/locale/trustycoin_cs.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_cs.ts -qm src/qt/locale/trustycoin_cs.qm

src/qt/locale/trustycoin_da.qm: src/qt/locale/trustycoin_da.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_da.ts -qm src/qt/locale/trustycoin_da.qm

src/qt/locale/trustycoin_de.qm: src/qt/locale/trustycoin_de.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_de.ts -qm src/qt/locale/trustycoin_de.qm

src/qt/locale/trustycoin_el_GR.qm: src/qt/locale/trustycoin_el_GR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_el_GR.ts -qm src/qt/locale/trustycoin_el_GR.qm

src/qt/locale/trustycoin_en.qm: src/qt/locale/trustycoin_en.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_en.ts -qm src/qt/locale/trustycoin_en.qm

src/qt/locale/trustycoin_es.qm: src/qt/locale/trustycoin_es.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_es.ts -qm src/qt/locale/trustycoin_es.qm

src/qt/locale/trustycoin_es_CL.qm: src/qt/locale/trustycoin_es_CL.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_es_CL.ts -qm src/qt/locale/trustycoin_es_CL.qm

src/qt/locale/trustycoin_et.qm: src/qt/locale/trustycoin_et.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_et.ts -qm src/qt/locale/trustycoin_et.qm

src/qt/locale/trustycoin_eu_ES.qm: src/qt/locale/trustycoin_eu_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_eu_ES.ts -qm src/qt/locale/trustycoin_eu_ES.qm

src/qt/locale/trustycoin_fa.qm: src/qt/locale/trustycoin_fa.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_fa.ts -qm src/qt/locale/trustycoin_fa.qm

src/qt/locale/trustycoin_fa_IR.qm: src/qt/locale/trustycoin_fa_IR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_fa_IR.ts -qm src/qt/locale/trustycoin_fa_IR.qm

src/qt/locale/trustycoin_fi.qm: src/qt/locale/trustycoin_fi.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_fi.ts -qm src/qt/locale/trustycoin_fi.qm

src/qt/locale/trustycoin_fr.qm: src/qt/locale/trustycoin_fr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_fr.ts -qm src/qt/locale/trustycoin_fr.qm

src/qt/locale/trustycoin_fr_CA.qm: src/qt/locale/trustycoin_fr_CA.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_fr_CA.ts -qm src/qt/locale/trustycoin_fr_CA.qm

src/qt/locale/trustycoin_gu_IN.qm: src/qt/locale/trustycoin_gu_IN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_gu_IN.ts -qm src/qt/locale/trustycoin_gu_IN.qm

src/qt/locale/trustycoin_he.qm: src/qt/locale/trustycoin_he.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_he.ts -qm src/qt/locale/trustycoin_he.qm

src/qt/locale/trustycoin_hi_IN.qm: src/qt/locale/trustycoin_hi_IN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_hi_IN.ts -qm src/qt/locale/trustycoin_hi_IN.qm

src/qt/locale/trustycoin_hr.qm: src/qt/locale/trustycoin_hr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_hr.ts -qm src/qt/locale/trustycoin_hr.qm

src/qt/locale/trustycoin_hu.qm: src/qt/locale/trustycoin_hu.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_hu.ts -qm src/qt/locale/trustycoin_hu.qm

src/qt/locale/trustycoin_it.qm: src/qt/locale/trustycoin_it.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_it.ts -qm src/qt/locale/trustycoin_it.qm

src/qt/locale/trustycoin_ja.qm: src/qt/locale/trustycoin_ja.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_ja.ts -qm src/qt/locale/trustycoin_ja.qm

src/qt/locale/trustycoin_lt.qm: src/qt/locale/trustycoin_lt.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_lt.ts -qm src/qt/locale/trustycoin_lt.qm

src/qt/locale/trustycoin_nb.qm: src/qt/locale/trustycoin_nb.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_nb.ts -qm src/qt/locale/trustycoin_nb.qm

src/qt/locale/trustycoin_nl.qm: src/qt/locale/trustycoin_nl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_nl.ts -qm src/qt/locale/trustycoin_nl.qm

src/qt/locale/trustycoin_pl.qm: src/qt/locale/trustycoin_pl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_pl.ts -qm src/qt/locale/trustycoin_pl.qm

src/qt/locale/trustycoin_pt_BR.qm: src/qt/locale/trustycoin_pt_BR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_pt_BR.ts -qm src/qt/locale/trustycoin_pt_BR.qm

src/qt/locale/trustycoin_pt_PT.qm: src/qt/locale/trustycoin_pt_PT.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_pt_PT.ts -qm src/qt/locale/trustycoin_pt_PT.qm

src/qt/locale/trustycoin_ro_RO.qm: src/qt/locale/trustycoin_ro_RO.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_ro_RO.ts -qm src/qt/locale/trustycoin_ro_RO.qm

src/qt/locale/trustycoin_ru.qm: src/qt/locale/trustycoin_ru.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_ru.ts -qm src/qt/locale/trustycoin_ru.qm

src/qt/locale/trustycoin_sk.qm: src/qt/locale/trustycoin_sk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_sk.ts -qm src/qt/locale/trustycoin_sk.qm

src/qt/locale/trustycoin_sr.qm: src/qt/locale/trustycoin_sr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_sr.ts -qm src/qt/locale/trustycoin_sr.qm

src/qt/locale/trustycoin_sv.qm: src/qt/locale/trustycoin_sv.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_sv.ts -qm src/qt/locale/trustycoin_sv.qm

src/qt/locale/trustycoin_th_TH.qm: src/qt/locale/trustycoin_th_TH.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_th_TH.ts -qm src/qt/locale/trustycoin_th_TH.qm

src/qt/locale/trustycoin_tr.qm: src/qt/locale/trustycoin_tr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_tr.ts -qm src/qt/locale/trustycoin_tr.qm

src/qt/locale/trustycoin_uk.qm: src/qt/locale/trustycoin_uk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_uk.ts -qm src/qt/locale/trustycoin_uk.qm

src/qt/locale/trustycoin_zh_CN.qm: src/qt/locale/trustycoin_zh_CN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_zh_CN.ts -qm src/qt/locale/trustycoin_zh_CN.qm

src/qt/locale/trustycoin_zh_TW.qm: src/qt/locale/trustycoin_zh_TW.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/trustycoin_zh_TW.ts -qm src/qt/locale/trustycoin_zh_TW.qm

compiler_moc_header_make_all: build/moc_trustycoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_trustycoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_trustycoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_rpcconsole.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_trustycoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_trustycoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_trustycoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_rpcconsole.cpp
build/moc_trustycoingui.cpp: src/qt/trustycoingui.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/trustycoingui.h -o build/moc_trustycoingui.cpp
...
build/moc_trustycoinaddressvalidator.cpp: src/qt/trustycoinaddressvalidator.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/trustycoinaddressvalidator.h -o build/moc_trustycoinaddressvalidator.cpp
...
build/moc_trustycoinamountfield.cpp: src/qt/trustycoinamountfield.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/trustycoinamountfield.h -o build/moc_trustycoinamountfield.cpp
...
compiler_rcc_make_all: qrc_trustycoin.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_trustycoin.cpp
qrc_trustycoin.cpp: src/qt/trustycoin.qrc \
		src/qt/locale/trustycoin_fa_IR.qm \
		src/qt/locale/trustycoin_hr.qm \
		src/qt/locale/trustycoin_hu.qm \
		src/qt/locale/trustycoin_zh_CN.qm \
		src/qt/locale/trustycoin_bg.qm \
		src/qt/locale/trustycoin_eu_ES.qm \
		src/qt/locale/trustycoin_fr.qm \
		src/qt/locale/trustycoin_nb.qm \
		src/qt/locale/trustycoin_tr.qm \
		src/qt/locale/trustycoin_pl.qm \
		src/qt/locale/trustycoin_ru.qm \
		src/qt/locale/trustycoin_nl.qm \
		src/qt/locale/trustycoin_uk.qm \
		src/qt/locale/trustycoin_it.qm \
		src/qt/locale/trustycoin_ca_ES.qm \
		src/qt/locale/trustycoin_ro_RO.qm \
		src/qt/locale/trustycoin_sk.qm \
		src/qt/locale/trustycoin_en.qm \
		src/qt/locale/trustycoin_el_GR.qm \
		src/qt/locale/trustycoin_es_CL.qm \
		src/qt/locale/trustycoin_he.qm \
		src/qt/locale/trustycoin_fa.qm \
		src/qt/locale/trustycoin_zh_TW.qm \
		src/qt/locale/trustycoin_es.qm \
		src/qt/locale/trustycoin_et.qm \
		src/qt/locale/trustycoin_pt_BR.qm \
		src/qt/locale/trustycoin_sr.qm \
		src/qt/locale/trustycoin_lt.qm \
		src/qt/locale/trustycoin_da.qm \
		src/qt/locale/trustycoin_cs.qm \
		src/qt/locale/trustycoin_pt_PT.qm \
		src/qt/locale/trustycoin_sv.qm \
		src/qt/locale/trustycoin_fi.qm \
		src/qt/locale/trustycoin_fr_CA.qm \
		src/qt/locale/trustycoin_de.qm \
		...
		src/qt/res/icons/trustycoin_testnet.png \
		...
		src/qt/res/icons/trustycoin.png \
	...
	/usr/lib/x86_64-linux-gnu/qt4/bin/rcc -name trustycoin src/qt/trustycoin.qrc -o qrc_trustycoin.cpp
...
build/trustycoin.o: src/qt/trustycoin.cpp src/qt/trustycoingui.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		src/qt/optionsmodel.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/trustycoin.o src/qt/trustycoin.cpp

build/trustycoingui.o: src/qt/trustycoingui.cpp src/qt/trustycoingui.h \
		src/qt/transactiontablemodel.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/trustycoingui.o src/qt/trustycoingui.cpp
...
build/trustycoinaddressvalidator.o: src/qt/trustycoinaddressvalidator.cpp src/qt/trustycoinaddressvalidator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/trustycoinaddressvalidator.o src/qt/trustycoinaddressvalidator.cpp
...
build/trustycoinstrings.o: src/qt/trustycoinstrings.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/trustycoinstrings.o src/qt/trustycoinstrings.cpp

build/trustycoinamountfield.o: src/qt/trustycoinamountfield.cpp src/qt/trustycoinamountfield.h \
		src/qt/qvaluecombobox.h \
		src/qt/trustycoinunits.h \
		src/qt/guiconstants.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/trustycoinamountfield.o src/qt/trustycoinamountfield.cpp
...
build/trustycoinrpc.o: src/trustycoinrpc.cpp src/init.h \
		src/wallet.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
		...
		src/json/json_spirit_writer_template.h \
		src/json/json_spirit_utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/trustycoinrpc.o src/trustycoinrpc.cpp
...
build/trustycoinunits.o: src/qt/trustycoinunits.cpp src/qt/trustycoinunits.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/trustycoinunits.o src/qt/trustycoinunits.cpp
...
build/moc_trustycoingui.o: build/moc_trustycoingui.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_trustycoingui.o build/moc_trustycoingui.cpp
...
build/moc_trustycoinaddressvalidator.o: build/moc_trustycoinaddressvalidator.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_trustycoinaddressvalidator.o build/moc_trustycoinaddressvalidator.cpp
...
build/moc_trustycoinamountfield.o: build/moc_trustycoinamountfield.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_trustycoinamountfield.o build/moc_trustycoinamountfield.cpp
...
build/qrc_trustycoin.o: qrc_trustycoin.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/qrc_trustycoin.o qrc_trustycoin.cpp
