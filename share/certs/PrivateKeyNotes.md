...
unlocked to sign the Trustycoin-Qt.app bundle.
...
allowing somebody to distribute a Trustycoin-Qt.app or trustycoin-qt-setup.exe with a valid
...
that the trustycoin-qt.exe file inside the installer had not been tampered with.
