...
WORKINGDIR="/tmp/trustycoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/trustycoin/Trustycoin/trustycoin-0.8.0/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/trustycoin/Trustycoin/"
VERSIONPREFIX="trustycoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'trustycoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[trustycoin-]<version>-[rc[0-9]] (example: trustycoin-0.7.1-rc1)"
   echo "wget output:"
