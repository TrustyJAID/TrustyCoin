...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("trustycoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Trustycoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strMainNetDNSSeed[][2] = {
    {"trustycoin.sipa.be", "seed.trustycoin.sipa.be"},
    {"bluematt.me", "dnsseed.bluematt.me"},
    {"dashjr.org", "dnsseed.trustycoin.dashjr.org"},
    {"xf2.org", "bitseed.xf2.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"trustycoin.petertodd.org", "testnet-seed.trustycoin.petertodd.org"},
    {NULL, NULL}
};
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("trustycoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("trustycoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("trustycoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("trustycoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Trustycoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    GenerateTrustycoins(GetBoolArg("-gen", false), pwalletMain);
}
...
bool StopNode()
{
    ...
    if (vnThreadsRunning[THREAD_MINER] > 0) printf("ThreadTrustycoinMiner still running\n");
