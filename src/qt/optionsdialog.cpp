    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new TrustycoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->trustycoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Trustycoin."), QMessageBox::Ok);
