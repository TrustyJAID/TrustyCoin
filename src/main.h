...
static const int64 MAX_MONEY = 9200000 * COIN; // maximum of 42 007 680 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 144 / 250; // 144 blocks found a day (6 blocs/hr * 24hr/day)./L. Priority cutoff is 1 LRC day / 250 bytes.
    }
